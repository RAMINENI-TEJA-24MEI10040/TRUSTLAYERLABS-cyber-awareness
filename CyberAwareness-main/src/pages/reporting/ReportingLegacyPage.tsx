/**
 * @deprecated Legacy reporting layout — not routed.
 * Canonical: `/reporting` → `ReportingCommandCenter` via `pages/reporting/index.tsx`.
 */
...
export default function ReportingLegacyPage() {
  return (
